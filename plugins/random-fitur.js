...
handler.command = handler.help = ['jadian2', 'menikah2', 'metercinta', 'bertanya', 'asmaulhusna', '', 'memeindo', 'stimker', 'randommeme', 'memedarkjoke', 'beasiswa', 'apkdown', 'proxysite', 'mirrorcreator', 'ouo', 'ouoshort', 'shortlink', 'shortlink2', 'shortlink3', 'shortlink4', 'sl']
handler.tags = ['random']
