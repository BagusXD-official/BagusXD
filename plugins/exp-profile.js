...
let handler = async (m, { conn }) => {
    ...
    let { role, premium, money, level, limit, exp, lastclaim, registered, regTime, age ,warn} = global.db.data.users[who]
    ...
    ${dashmenu}
*User Profil*
👤 • *Username:* ${user.registered ? user.name : 'kamu belum terdaftar!'}
...
handler.command = /^(profile|profil|my|me)$/i
