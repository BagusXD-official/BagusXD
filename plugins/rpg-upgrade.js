      ...
      case 'fishingrod':
        if (fishingrod == 0) {
          ...
          if (user.kayu < _kayu || user.string < _string || user.money < _money) {
            ...
            m.reply(`Sukses mengupgrade *${rpg.emoticon('fishingrod')}FishingRod*`);
          }
        }
        break;
      case 'pickaxe':
        if (pickaxe == 0) {
          ...
          if (user.batu < __batu || user.kayu < __kayu || user.money < __money) {
            ...
            m.reply(`Sukses mengupgrade *${rpg.emoticon('pickaxe')}Pickaxe*`);
          }
        }
        break;
      case 'sword':
        if (sword == 0) {
          ...
          if (user.iron < _iron || user.kayu < ___kayu || user.money < ___money) {
            ...
            m.reply(`Sukses mengupgrade *${rpg.emoticon('sword')}Sword*`);
          }
        }
        break;
      default:
