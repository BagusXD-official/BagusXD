let handler = async (m, { conn, args }) => {
    if (!args || !args[0]) throw '❔Siapa yang mau di Unwarning ?'
    ...
    conn.reply(mention, '*Kamu telah di Unwarning OWNER Atau MODERATOR, sekarang kamu memiliki*' + (global.db.data.users[mention].warn * 1) + '*warning*', null)
}
