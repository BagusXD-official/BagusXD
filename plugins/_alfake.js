...
handler.all = async function (m) {
  //  let name = await conn.getName(m.sender) 
	let pp = 'https://telegra.ph/file/7517dfdca23570f039309.jpg'
	try {
		pp = 'https://telegra.ph/file/7517dfdca23570f039309.jpg'
	} catch (e) {
	} finally {
   global.pu = pp
	...
	global.kontak2 = [
	[owner[0], await conn.getName(owner[0] + '62895700121662@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'bagusxd@gmail.com', false],
	[owner[1], await conn.getName(owner[1] + '@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'bagusxd@gmail.com', false], ]
