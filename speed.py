...
class SpeedtestResults(object):
    ...
    def share(self):
        ...
        download = int(round(self.download / 10.0, 0))
        ping = int(round(self.ping, 0))
        upload = int(round(self.upload / 10.0, 0))
...
def shell():
    ...
    if args.upload:
        speedtest.upload()
        printer('*🚀 Upload:* %0.2f G%s/s' %
                ((results.upload / 1000.0 / 1000.0) / args.units[1],
                 args.units[0]),
                quiet)
        printer("\n...................................................................................\n▶︎ Pᴏᴡᴇʀ Bʏ *WINWIN-BOT MD⚡*")
    else:
