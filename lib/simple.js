...
END:VCARD`.trim()
    ...
    sendBut: {
        async value (jid, content, footerText, button1, id1, quoted, options) {
                ...
                conn.sendMessage(jid, buttonMessage, { quoted, contextInfo: { mentionedJid: conn.parseMention(content + footerText), forwardingScore: 999999, isForwarded: true }, ...options })
            }
        },
        send2Button: {
